  ...
  return (
    <div className="find_character">
      <Formik
        ...
        onSubmit={values => {
          setNameChar(nameChar => values.nameChar),
          setChar(null),
          setCharNotFind(false)
        }}
...
const CharWasNotFind = () => {
  return (
    <p className='message_block error_message'>The character was not found. Check the name and try again</p>
  )
}
